    ...
    {loading?<div className="glass-panel rounded-2xl p-8 text-center text-body-secondary">Chargement des données de recherche...</div>:stats&&<>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <section className="glass-panel rounded-2xl p-6">
          ...
          <p className="text-xs text-body-secondary mt-4">La confiance moyenne et le taux de confirmation décrivent le corpus. Accuracy, précision, rappel et F1 nécessitent des labels de référence indépendants et seront calculés lorsque ce jeu de référence sera constitué.</p>
        </section>
      </div>
